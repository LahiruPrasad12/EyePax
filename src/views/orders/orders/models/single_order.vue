<template>
    <ion-modal :is-open="is_model_open">
        <ion-content>
            <ion-toolbar>
                <ion-title>{{ item.order_id }}</ion-title>
            ...
            <ion-list>
               ...
               <ion-avatar style="display: flex;justify-content: center;">
                 <ion-img src="https://i.postimg.cc/QMkZFG1K/layers-animat.gif"></ion-img>
                        ...
                        <ion-col size="13">
                            <ion-label style="font-weight:500">Item</ion-label>
                        ...
                        <ion-col size="13">
                            <ion-label style="font-weight:500">Total Price</ion-label>
                            <ion-text color="medium">
                                <h6>Rs. {{ (item.price * item.qty).toLocaleString("en-US") }}</h6>
                            </ion-text>
                        </ion-col>
                        <ion-col size="13">
                            <ion-label style="font-weight:500">Order Date</ion-label>
                            <ion-text color="medium">
...
export default defineComponent({
    ...
    methods: {
        ...
        updateItem() {
            this.$emit('openUpdateOrderModal', this.item)
            this.is_model_open = !this.is_model_open
        },
